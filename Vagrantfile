...
MACHINES= [
  ...
  { name: "facility", ip: ip(141), primary: false, cpus: 1, mem: 1024      , add_disk: false },
  { name: "master"  , ip: ip(122), primary: false, cpus: 2, mem: MASTER_RAM, add_disk: ADD_DISK_FLAG, size: DISK_SIZE },
  { name: "node1"   , ip: ip(131), primary: false, cpus: 1, mem: NODE_RAM  , add_disk: ADD_DISK_FLAG, size: DISK_SIZE },
  { name: "node2"   , ip: ip(132), primary: false, cpus: 1, mem: NODE_RAM  , add_disk: ADD_DISK_FLAG, size: DISK_SIZE },
